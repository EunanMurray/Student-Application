...
{
    /// <inheritdoc />
    public partial class InitSet234 : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CommitteeMemberSports", x => new { x.UserId, x.SportId });
                    table.ForeignKey(
                        name: "FK_CommitteeMemberSports_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
