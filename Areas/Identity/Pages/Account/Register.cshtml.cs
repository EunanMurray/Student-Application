        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    ...
                    // Ensure callbackUrl and Input.Email are not null
                    if (!string.IsNullOrEmpty(callbackUrl) && !string.IsNullOrEmpty(Input.Email))
                    {
                    ...
                    {
                        ModelState.AddModelError(string.Empty, "Failed to generate a confirmation link. Please try again.");
                        return Page();
                    }
